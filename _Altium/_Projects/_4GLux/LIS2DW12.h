...
#define LIS_LATCHED_IRQ_MASK		4
#define LIS_LATCHED_IRQ				0x1

/* CTRL_REG4_INT1 */
#define LIS_SINGLE_TAP_MASK			6
#define LIS_SINGLE_TAP				0x1

#define LIS_DOUBLE_TAP_MASK			3
#define LIS_DOUBLE_TAP				0x1

/* INT_DUR */
#define LIS_LATENCY_MASK			4
#define LIS_LATENCY_TEST1			0x6
#define LIS_QUIET_MASK				2
#define LIS_QUIET_TEST1				0x3
#define LIS_SHOCK_MASK				0
#define LIS_SHOCK_TEST1				0x3

/* TAP_THS_X */
#define LIS_TAP_THSX_MASK			0
#define LIS_TAP_THSX_20				0xA

/* TAP_THS_Z */
#define LIS_TAP_X_EN				1
#define LIS_TAP_X_EN_MASK			7

/* CTRL_REG7 */
#define LIS_IRQ_EN_MASK				5
#define LIS_IRQ_EN					0x1

/* WAKE_UP_THS */
#define LIS_SINGLE_DOUBLE_MASK		7
#define LIS_SINGLE_DOUBLE			1
...
#define LIS_LOW_NOISE_MASK			2
#define LIS_LOW_NOISE				0x1
